import {
  Category, Product, Table, TableStatus, Order, OrderStatus,
  User, Reservation, ReservationStatus, Supplier, StockLog, StockTransactionType
} from './types'
...
export const MOCK_RESERVATIONS: Reservation[] = [
  {
    ...
    reservationTime: new Date(new Date().setHours(18, 30)).toISOString(),
    guests: 4,
  ...
  },
  {
    ...
    reservationTime: new Date(new Date().setHours(19, 0)).toISOString(),
    guests: 8,
